    ...
    <div className="bg-[#f2f2f2] p-5 rounded-[20px] flex justify-center">
      <div className="innerDiv w-[95%] py-5">
        ...
        <div className="my-5">
          {tacData.map((tac)=>(
            ...
            <div className="py-3">
              ...
              <ul className="list-disc pl-5">
                {tac.subitems.map((item)=>(<li className="font-[450] text-[16px] leading-[32px] text-[#333333]" key={item.id}>
                  {item.text}
                  </li>))}
              </ul>
            </div>
          ...
          <p className="my-3 text-[16px] leading-[20.24px] font-[450] text-[#333333]">Take the first step, and let us assist you in achieving SOC 2 compliance. contact us <a href="mailto:inquiries@delegation.com" className="!text-[#00A96E]">inquiries@delegation.com</a></p>
        </div>
      </div>
    </div>
  );
