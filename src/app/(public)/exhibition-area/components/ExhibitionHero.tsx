...
const ExhibitionHero = () => {
  ...
  return (
    ...
    <div className="h-[70vh] sm:h-[50vh] md:h-[60vh] lg:h-[70vh] 2xl:h-[80vh] bg-exhibition-home-hero w-full flex justify-center items-end">
      <div className="w-[95%] sm:w-[90%] lg:w-[85%] mb-[7rem] flex items-start">
