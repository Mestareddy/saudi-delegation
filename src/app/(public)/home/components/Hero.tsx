  ...
  return (
    <div className="h-[70vh] sm:h-[50vh] md:h-[60vh] lg:h-[70vh] 2xl:h-[80vh] bg-home-hero w-full flex justify-center items-end">
      <div className="innerDiv mb-5 flex flex-col sm:items-center mx-5">
        ...
        <p className="text-center text-white text-[20px] circularMedium my-2">
        ...
        <div className="dividerDiv w-full flex flex-row justify-center items-center mb-3">
          ...
          <h1 className="flex-grow whitespace-nowrap text-[16px] sm:text-[20px] leading-[25px] font-bold text-white circularMedium">
        ...
        <div className="links my-5 flex flex-row items-center justify-center">
          <Link
            ...
            className="event mx-3 sm:mx-8 flex items-center flex-row text-white inter"
          >
            Event brochure
          ...
          <Link
            href={"/gallery"}
            className="gallery mx-3 sm:mx-8 flex items-center flex-row text-white inter"
          >
            Gallery
            <ArrowRightUpIcon size="18px" className="ml-1" stroke="#ffffff" />
          </Link>
